...
| --- | --- | --- | --- |
| `t` | `superset-frontend/packages/superset-core/src/translation/TranslatorSingleton.ts` | 237 | 1381 `AMBIGUOUS` |
| `useTheme` | `superset-frontend/packages/superset-core/src/theme/index.tsx` | 191 | 203 `AMBIGUOUS` |
| `transaction` | `superset/utils/decorators.py` | 96 | 98 `EXTRACTED` |
| `ensureIsArray` | `superset-frontend/packages/superset-ui-core/src/utils/ensureIsArray.ts` | 70 | 142 `AMBIGUOUS` |
| `SupersetError` | `superset/errors.py` | 70 | 122 `EXTRACTED` |
| `onChange` | `superset-frontend/src/explore/components/controls/DateFilterControl/components/AdvancedFrame.tsx` | 67 | 2 `EXTRACTED`, 121 `AMBIGUOUS` |
| `onChange` | `superset-frontend/src/explore/components/controls/DateFilterControl/components/CustomFrame.tsx` | 67 | 7 `EXTRACTED`, 121 `AMBIGUOUS` |
| `onChange` | `superset-frontend/src/explore/components/controls/ColumnConfigControl/ControlForm/index.tsx` | 66 | 121 `AMBIGUOUS` |
| `get_user_id` | `superset/utils/core.py` | 59 | 70 `EXTRACTED` |
| `tool` | `superset-core/src/superset_core/mcp/decorators.py` | 55 | 55 `EXTRACTED` |
| `ValidationError` | `superset/mcp_service/common/error_schemas.py` | 55 | 84 `AMBIGUOUS` |
| `ForeignKey` | `superset/migrations/shared/constraints.py` | 54 | 15 `EXTRACTED`, 96 `AMBIGUOUS` |
| `ChartMetadata` | `superset-frontend/packages/superset-ui-core/src/chart/models/ChartMetadata.ts` | 49 | 1 `EXTRACTED`, 48 `AMBIGUOUS` |
| `Table` | `superset/sql/parse.py` | 48 | 33 `EXTRACTED`, 20 `AMBIGUOUS` |
| `withToasts` | `superset-frontend/src/components/MessageToasts/withToasts.tsx` | 45 | 45 `AMBIGUOUS` |
