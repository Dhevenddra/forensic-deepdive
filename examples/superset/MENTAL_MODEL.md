...
- A **Typescript** codebase of 3,871 source file(s).
...
2. `superset-frontend/packages/superset-core/src/theme/index.tsx` (centrality 0.0207)
3. `superset-frontend/packages/superset-core/src/translation/Translator.ts` (centrality 0.0193)
4. `superset/utils/core.py` (centrality 0.0131)
