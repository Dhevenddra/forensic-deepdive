...
- A **Python** codebase of 75 source file(s).
...
1. `fastapi/applications.py` (centrality 0.1105)
2. `fastapi/datastructures.py` (centrality 0.0629)
3. `fastapi/param_functions.py` (centrality 0.0508)
4. `fastapi/params.py` (centrality 0.0508)
5. `fastapi/exceptions.py` (centrality 0.0454)
6. `fastapi/_compat/shared.py` (centrality 0.0445)
7. `fastapi/encoders.py` (centrality 0.0414)
8. `fastapi/openapi/docs.py` (centrality 0.0353)
