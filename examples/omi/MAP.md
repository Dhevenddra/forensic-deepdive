...
- **Source files:** 2,113 (+36 in graph, demoted as examples/)
- **Languages:** Dart (555), Python (459), Tsx (357), Swift (314), Typescript (222), C (101), Javascript (58), Rust (46), Java (1)
- **Symbols:** 32,496 definitions, 690,354 references
- **Symbol graph:** 2048 files, 18276 dependency edges
- **Test surface:** 270 test file(s), 0 fixture file(s) (inventoried, excluded from the dependency graph)
- **Non-authored:** 410 vendored, 11 generated (inventoried, excluded from the dependency graph)
- **Example/tutorial:** 36 file(s) (in the dependency graph but demoted in ranking + query)
...
| --- | --- | --- | --- |
| 1 | `app/lib/utils/logger.dart` | 0.0412 | Logger, error, debug, onError… |
| 2 | `app/lib/services/services.dart` | 0.0232 | instance, start, ServiceManager, init… |
| 3 | `desktop/Desktop/Sources/Logger.swift` | 0.0218 | log, logError, logSync, measurePerfAsync… |
| 4 | `app/lib/pages/settings/people.dart` | 0.0160 | onPressed, UserPeoplePage, initState |
| 5 | `app/lib/utils/responsive/responsive_helper.dart` | 0.0141 | contentPadding, ResponsiveHelper, spacing, iconSize… |
| 6 | `app/lib/utils/debug_log_manager.dart` | 0.0128 | DebugLogManager, clear |
