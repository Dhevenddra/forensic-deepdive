...
| --- | --- | --- | --- |
| `format_point` | `route_guide_client.py` | 6 | 6 `EXTRACTED` |
| `make_route_note` | `asyncio_route_guide_client.py` | 5 | 5 `EXTRACTED` |
| `make_route_note` | `route_guide_client.py` | 5 | 5 `EXTRACTED` |
| `read_route_guide_database` | `route_guide_resources.py` | 4 | 4 `INFERRED` |
| `guide_get_one_feature` | `asyncio_route_guide_client.py` | 2 | 2 `EXTRACTED` |
| `get_feature` | `asyncio_route_guide_server.py` | 2 | 2 `EXTRACTED` |
| `guide_get_one_feature` | `route_guide_client.py` | 2 | 2 `EXTRACTED` |
